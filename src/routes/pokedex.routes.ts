...
// 			const results = await pokedexController.getAllGeneration(
// 				generationPokemon
// 			);
// 			return res.status(200).send(results);
// 		} catch (error) {
...
// 		try {
// 			const result = await pokedexController.getByResistance(
// 				resistancePokemon
// 			);
// 			return res.status(200).send(result);
// 		} catch (error) {
...
// pokedexRouter.get(
// 	'/pokemon/:nom/resistances',
// 	async (req: Request, res: Response) => {
// 		//On vérifie que la résistance du pokémon soit valide
// 		const nomPokemon = String(req.params.nom);
// 		try {
// 			const result = await pokedexController.getByNameResistance(nomPokemon);
// 			return res.status(200).send(result);
// 		} catch (error) {
// 			let message = error instanceof Error ? error.message : 'unknown error';
// 			return res.status(404).send(message);
